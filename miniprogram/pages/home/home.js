...
Page({
  data: { config: null, categories: ['全部好物'], category: '', query: '', items: [], page: 1, loading: false, hasMore: false, error: '' },
  ...
  onShareAppMessage() { return { title: '青集 · 让校园好物继续被喜欢', path: '/pages/home/home' }; }
});
